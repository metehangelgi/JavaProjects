...
public class HashSet<Key> implements iSet<Key>, iPrintable<Key>{
  ...
  // A default public constructor is mandatory!
	...
	HashMapSC<Key, Object> EntrySet;
	
  public HashSet() {
   /*
    * Add code here
    */
	  EntrySet=new HashMapSC<Key, Object>();
  }
  ...
  public boolean contains(Key k) {
    // TODO Auto-generated method stub
	  Object foundOne=EntrySet.get(k);
	  if(foundOne!=null) return true;
    return false;
  }
  ...
  public boolean put(Key k) {
    // TODO Auto-generated method stub
	  Object v=EntrySet.put(k, new Object());
