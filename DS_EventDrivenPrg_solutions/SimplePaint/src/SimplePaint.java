...
public class SimplePaint extends GraphicsProgram {
    ...
    private JComboBox<String> colorChooser;	// Choose between RED, GREEN, BLUE
	...
	String c = (String) colorChooser.getSelectedItem();
	switch(c) {
	...
	String s = (String) shapeChooser.getSelectedItem();
	if (s.equals("GRect")) {
	...
	if(e.getSource().equals("Clear")) removeAll();
	// Your code ends here
    }
}
