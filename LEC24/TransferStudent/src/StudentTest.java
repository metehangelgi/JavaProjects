 ...
 * ----------------------
 * Simple test of the Student and TransferStudent classes.
 */
...
public class StudentTest extends ConsoleProgram {
	...
	public void run() {
		...
		TransferStudent rookie = new TransferStudent("Ahmet Savran", 354672,"Bogazici University");
		rookie.setUnits(34);
		rookie.setPaidUp(false);
		testEligibility(rookie);
